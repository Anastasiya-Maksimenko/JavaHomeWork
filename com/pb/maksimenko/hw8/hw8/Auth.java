    ...
    public void signUp(String login, String password, String confirmPassword)
        ...
        if (login.length() >= 5 && login.length() <= 20) {
            if (login.matches("[a-zA-Z0-9]*")) {
                ...
                WrongLoginException wl1 = new WrongLoginException(
                        "Логин НЕ должен содержать символы или русские буквы!");
                throw wl1;
            }
        } else {
        ...
        System.out.println(
                "Придумайте пароль (от 5 символов, содержит только латинские буквы и цифры и знак подчеркивания)");
